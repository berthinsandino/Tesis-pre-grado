...
\setcounter{secnumdepth}{0}
  ...
  %como teoría acerca de Procesamiento Digital de Imágenes, algoritmos 
  %heurísticos, \textit{Machine Learning}, y los algoritmos \textit{K-means} 
  %y \textit{Unionf find}.
  %Dada la importancia de algunos conceptos básicos, se consideró dividir el
  %marco teórico en tres capítulos.
  %Debido a la importancia de algunos temas, se consideró el desarrollo de 
  %conceptos básicos de probabilidades y procesamiento de imágenes.
...
\begin{minipage}{\textwidth}
  ...
  \subfloat[]{\label{Fig:Cap-marcoteorico:7VentanasTransformaciones.b}\includegraphics[height=35mm]{/Cap:MarcoTeorico/GrayScale_FotosCalles_30.jpg}}{ }
  \subfloat[]{\label{Fig:Cap-marcoteorico:7VentanasTransformaciones.c}\includegraphics[height=35mm]{/Cap:MarcoTeorico/Invert_FotosCalles_30.jpg}}
  \\
  \subfloat[]{\label{Fig:Cap-marcoteorico:7VentanasTransformaciones.d}\includegraphics[height=35mm]{/Cap:MarcoTeorico/Levels_FotosCalles_30.jpg}}{ } 
  \subfloat[]{\label{Fig:Cap-marcoteorico:7VentanasTransformaciones.e}\includegraphics[height=35mm]{/Cap:MarcoTeorico/Levels-Histograma_FotosCalles_30.jpg}}
  \\
  \subfloat[]{\label{Fig:Cap-marcoteorico:7VentanasTransformaciones.f}\includegraphics[height=35mm]{/Cap:MarcoTeorico/Threshold_FotosCalles_30.jpg}}{ }
  \subfloat[]{\label{Fig:Cap-marcoteorico:7VentanasTransformaciones.g}\includegraphics[height=35mm]{/Cap:MarcoTeorico/Threshold-Histograma_FotosCalles_30.jpg}}
  \\
  \subfloat[]{\label{Fig:Cap-marcoteorico:7VentanasTransformaciones.h}\includegraphics[height=35mm]{/Cap:MarcoTeorico/AfterProc_FotosCalles_30.jpg}}{ }
...
$N_4(p) = \lbrace (x', y') ~/~ (x', y') \in \mathrm{Z}^2 \wedge |x - x'| + |y - y'| = 1 \rbrace$. %, donde $\delta_H$ representa la \textbf{distancia Hamiltoneana}. 
